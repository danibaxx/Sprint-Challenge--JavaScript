...
let speak = () => 'RAWERSRARARWERSARARARRRR!';
  dino1.speak = speak;
...
const contactInfo = [];
for (let i = 0; i < graduates.length; i++) {
  contactInfo.push(`Name: ${graduates[i].first_name} Email: ${graduates[i].email}`)
}
...
*/
const largerPopulation = zooAnimals.filter(populi => populi.population < 5);
...
*/
const populationTotal = zooAnimals.reduce (function(acc, current) {
